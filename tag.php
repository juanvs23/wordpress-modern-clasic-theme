    ...
    <div class="container">
        <header class="archive-header text-center mb-44">
            ...
            <?php if ( $tag_description ) : ?>
                <p class="text-soft mx-auto max-w-full md:mx-w-800"><?php echo wp_kses_post( $tag_description ); ?></p>
            <?php endif; ?>
        </header>
        ...
        <?php else : ?>
            <p class="text-center text-soft"><?php esc_html_e( 'No posts found for this tag.', 'ignite-theme' ); ?></p>
        <?php endif; ?>
    </div>
</main>
