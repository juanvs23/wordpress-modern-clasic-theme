...
<main id="site-content" class="ignite-section bg-soft">
    <div class="container">
        <header class="archive-header text-center mb-44">
            ...
            <?php if ( $term_content ) : ?>
                <p class="text-soft mx-auto max-w-full md:mx-w-800"><?php echo wp_kses_post( $term_content ); ?></p>
            <?php endif; ?>
        </header>
        ...
        <?php else : ?>
            <p class="text-center text-soft"><?php esc_html_e( 'No content was found for this term.', 'ignite-theme' ); ?></p>
        <?php endif; ?>
    </div>
</main>
